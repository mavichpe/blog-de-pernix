<footer id="footer">
    ...
    <section id="footerLow">
        <section id="slogan">Pernix Agile Software Craftsman</section>
        <section id="footerLogoPernix"><img alt="Pernix Logo" src="http://pernix-solutions.com/images/logo.png" /></section>
        <section id="businessCard">
            <section id="telefonos">USA: +1-224-788-2930<br />Costa Rica: +506-8823-0938</section>
            <section id="email">info@pernix-solutions.com</section>
        </section>
    </section>
</footer>
</div>
